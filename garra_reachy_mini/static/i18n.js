...
const TEXTOS = {
  en: {
    ...
    'agentes.carregando': 'loading…',
    'agentes.administrar_em': 'Read-only here. To edit, open the panel on the computer that runs the gateway:',
    ...
    'conversa.wake': 'Require an activation phrase',
    'conversa.wake_dica': 'On, the robot only listens after hearing the phrase — anything said without it is ignored and never reaches the chat, the history or the model. \'Stop\' always works. This is independent of the voice output switch: the robot can listen and obey while answering only in the chat.',
    'conversa.wake_texto': 'Activation phrase',
    'conversa.wake_janela': 'Close after silence of',
    'conversa.wake_teto': 'Maximum session',
  ...
  pt: {
    ...
    'agentes.carregando': 'carregando…',
    'agentes.administrar_em': 'Aqui é somente leitura. Para editar, abra o painel no computador que roda o gateway:',
    ...
    'conversa.wake': 'Exigir frase de ativação',
    'conversa.wake_dica': 'Ligado, o robô só escuta depois de ouvir a frase — o que for dito sem ela é ignorado e não chega ao chat, ao histórico nem ao modelo. \'Pare\' sempre funciona. É independente do interruptor de voz: o robô pode escutar e obedecer respondendo só no chat.',
    'conversa.wake_texto': 'Frase de ativação',
    'conversa.wake_janela': 'Fechar após silêncio de',
    'conversa.wake_teto': 'Sessão máxima',
